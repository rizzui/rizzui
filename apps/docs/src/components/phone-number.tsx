...
const inputClasses = {
  ...
  variant: {
    active: {
      base: "!border focus:ring-[0.6px] !bg-gray-0 placeholder:!opacity-80 read-only:focus:!ring-0",
      color: {
        DEFAULT:
        ...
        danger: "!border-red focus:enabled:!border-red focus:!ring-red !text-red-dark",
        info: "!border-blue focus:enabled:!border-blue focus:!ring-blue !text-blue-dark",
        success: "!border-green focus:enabled:!border-green focus:!ring-green !text-green-dark",
        warning:
    ...
    text: {
      ...
      color: {
        DEFAULT: "hover:!text-gray-1000 focus:!ring-gray-900/20 placeholder:!text-gray-500",
        ...
        success: "hover:!text-green-dark focus:!ring-green/30 !text-green placeholder:!opacity-100",
        warning:
...
const dropdownClasses = {
  ...
  highlightListColor: {
    DEFAULT: "[&>li.country.highlight]:!bg-gray-100 [&>li.country:hover]:!bg-gray-100",
    primary:
    ...
    danger: "[&>li.country.highlight]:!bg-red-lighter/70 [&>li.country:hover]:!bg-red-lighter/70",
    ...
    warning: "[&>li.country.highlight]:!bg-red-lighter/80 [&>li.country:hover]:!bg-red-lighter/80",
  },
};
...
const PhoneNumber = ({
  ...
  <div className={cn("rizzui-phone-number", className)}>
    {label && (
      <label className={cn("block", labelClasses.size[size], labelClassName)}>{label}</label>
    )}
