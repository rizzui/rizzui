...
export function CopyButton({ value, className }: CopyButtonProps) {
    ...
    return (
        <button
            ...
            className={
                cn(
                    "shrink-0 cursor-pointer border-0 p-0 flex items-center relative justify-center w-8 h-8 text-sm bg-white/70 backdrop-blur rounded transition-all ease-in-out hover:bg-white/90 shadow-xl",
                    className
                )
            }
        >
