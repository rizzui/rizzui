      ...
      <div className="container relative mx-auto">
        <header className="text-center">
          <Announcement
            ...
            className="mb-6 md:!mb-7 mx-auto border border-border"
          >
          ...
          <div className="flex items-center justify-center gap-4 md:gap-5">
            <Button
              size="lg"
              className="text-sm md:text-base h-12 px-6 hover:shadow-2xl transition-all relative min-w-[160px]"
            ...
            >
              <Button
                ...
                as="span"
                variant="outline"
                className="!text-sm md:!text-base h-12 bg-white dark:bg-gray-50 px-8 xl:px-9 transition-all relative"
              >
                <svg
