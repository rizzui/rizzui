...
export default function ComponentCard({ item }: any) {
  ...
  return (
    <div
      ...
      className={cn(
        'flex flex-col rounded-lg border border-border flex-shrink-0 relative overflow-hidden group/card cursor-pointer transition-all [box-shadow:0_1.5px_0_var(--border-color)]',
      )}
    >
