...
export default function Paper({
	...
	return (
		<div
			className={cn(
				'mb-2.5 pt-10 pb-12 min-h-[200px] flex flex-col justify-center items-center px-6 relative shadow rounded-lg border border-gray-200',
		...
		>
			...
			{!disableShowCodeBtn ? (
				<Button
					size="sm"
					variant="outline"
					className="absolute h-7 bottom-2 right-2"
