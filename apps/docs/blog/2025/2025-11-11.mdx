---
title: RizzUI 2.0.0
description: Major release with Tailwind CSS v4, CSS-first configuration, modern React patterns, and new UploadZone component.
authors: [idris, nahid]
date: 2025-11-11
---
...
- [New UploadZone Component](#new-uploadzone-component)
...
- **Tree-Shakeable**: Import only what you need: `import { UploadZone } from 'rizzui/upload-zone'`
- **Performance Optimized**: Efficient memory management with automatic URL cleanup
