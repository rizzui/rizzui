...
<Paper>
  <Dropdown placement="bottom-end">
    ...
    <Dropdown.Menu className="w-56 text-sm text-gray-600">
...
| :-------: | :--------------------------------------: | :---------------------------------------------------------------------: | :--------------: |
| children  |                   \_\_                   |        Use **Dropdown.Trigger** & **Dropdown.Menu** as children         |       \_\_       |
...
| disabledClassName |                  `string`                  |               To style disabled state of the **Dropdown.Item**                |   \_\_   |
