  ...
  <Dropdown placement="bottom-end">
    ...
    <Dropdown.Menu className="w-56 divide-y text-sm font-inter text-gray-600">
      ...
      <div className="mt-3 mb-2 pt-2">
        <Dropdown.Item className="hover:bg-gray-900 hover:text-gray-0">
          Account Settings
        </Dropdown.Item>
        <Dropdown.Item className="hover:bg-gray-900 hover:text-gray-0">
          Support
...
| :-------: | :--------------------------------------: | :-----------------------------------------------------------------: | :--------------: |
| children  |                  \_ \_                   | Use **Dropdown.Trigger** & Dropdown.Menu as a children for dropdown |      \_ \_       |
...
| disabledClassName |     `string`     |                To style disbale state of the **Dropdown.Item**                |  \_ \_   |
