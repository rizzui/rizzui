...
You can control Popover state with **isOepn** and **setIsOpen** props:
...
export default function App() {
  ...
  return (
    <Popover isOepn={isOepn} setIsOpen={setIsOpen}>
      <Popover.Trigger>
        <Button variant="outline">Open Popover</Button>
      </Popover.Trigger>
      <Popover.Content>
...
|       size       |      [PopoverSizes](#popover-sizes)      |                     Supported popover sizes are:                     | `"DEFAULT"` |
...
|      shadow      |    [PopoverShadow](#popover-shadows)     |                    Supported popover shadows are:                    | `"DEFAULT"` |
