...
A content area which can be collapsed and expanded. Completely unstyled, fully accessible UI components, designed to integrate beautifully with Tailwind CSS. Visit our [TanStack Table](/docs/integrations/tan-stack-table) integration page for a full table example with **TanStack Table**.
