...
You can change the style of the **Badge** with property **variant**
...
You can change the size of the **Badge** with property **size**
...
You can change the border radius of the **Badge** with property **rounded**
...
You can change the color of the **Badge** with property **color**
