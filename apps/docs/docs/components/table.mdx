...
React table component with useful functions. Under the hood we are using rc-table package, you can check their official documentation for more details -> https://www.npmjs.com/package/rc-table
