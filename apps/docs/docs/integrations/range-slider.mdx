...
<Tabs groupId="package-manager">
  <TabItem
    ...
    default
  >
    <CodeBlock language="bash">{`npm install rc-slider`}</CodeBlock>
  </TabItem>
  <TabItem
    value="yarn"
    label={
  ...
  >
    <CodeBlock language="bash">{`yarn add rc-slider`}</CodeBlock>
  </TabItem>
  <TabItem
    value="pnpm"
    label={
  ...
  >
    <CodeBlock language="bash">{`pnpm add rc-slider`}</CodeBlock>
  </TabItem>
  <TabItem
    value="bun"
    label={
  ...
  >
    <CodeBlock language="bash">{`bun add rc-slider`}</CodeBlock>
  </TabItem>
</Tabs>
