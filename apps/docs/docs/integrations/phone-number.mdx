...
A Highly customizable phone input component with auto formatting. We are using **react-phone-input-2** package. Please follow their [**Official documentation**](https://www.npmjs.com/package/react-phone-input-2) for more details.
