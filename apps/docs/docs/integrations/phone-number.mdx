...
2. Create a file called **phone-number.tsx** inside your components directory. And then copy and paste the following code into that file.
...
export default function App() {
	return (
		<>
			<PhoneNumber label="Phone Number Active" country="us" variant="active" />
	...
	return (
		<>
			<PhoneNumber
				...
				variant="active"
			/>
			<PhoneNumber label="Phone Number" country="us" variant="active" />
			<PhoneNumber
				label="Phone Number"
				country="us"
				rounded="lg"
...
export default function App() {
	return (
		<>
			<PhoneNumber label="Phone Number" country="us" variant="flat" />
			<PhoneNumber
				label="Phone Number"
				country="us"
				variant="flat"
