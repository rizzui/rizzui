...
import PhoneNumber, { PhoneNumberDefault } from "@site/src/components/phone-number";
import Paper from "@site/src/components/paper";

# PhoneNumber

A Highly customizable phone input component with auto formatting. We are using **react-phone-input-2** package for **PhoneNumber** component. Please follow their [**Official documentation**](https://www.npmjs.com/package/react-phone-input-2) for any query.
...
You can change the style of **PhoneNumber** with property **color**.
...
You can change the style of **PhoneNumber** with property **error**.
...
Here is the API documentation of the PhoneNumber component. These are some basic props.

You can also use all the other props from **phone-number-input-2** package.
...
|       size        |    [PhoneNumberSizes](#phonenumber-sizes)    | The size of the component. `"sm"` is equivalent to the dense input styling. | `"DEFAULT"` |
|      rounded      |  [PhoneNumberRounded](#phonenumber-rounded)  |                          The rounded variants are                           | `"DEFAULT"` |
|       color       |   [PhoneNumberColors](#phonenumber-colors)   |                             Change input color                              | `"DEFAULT"` |
...
```ts
type PhoneNumberSizes = "sm" | "DEFAULT" | "lg" | "xl";
```
...
```ts
type PhoneNumberRounded = "sm" | "DEFAULT" | "lg" | "none" | "pill";
```
