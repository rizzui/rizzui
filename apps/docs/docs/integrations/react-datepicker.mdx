...
.react-datepicker-popper .react-datepicker {
  @apply bg-gray-50 font-inter text-gray-600 dark:border-gray-300 dark:bg-gray-100;
}
...
.react-datepicker .react-datepicker__header {
  @apply border-b-gray-50 bg-gray-50 font-lexend dark:border-transparent dark:bg-gray-100;
}
...
.react-datepicker .react-datepicker__day--today {
  @apply rounded-full border border-gray-300 bg-gray-50 leading-[26px] text-gray-900;
