...
We have three different styles. You can select any of them using [**variant**](#pincode-variants) property.
...
You can set different sizes of the **PinCode** using [**size**](#pincode-sizes) property.
