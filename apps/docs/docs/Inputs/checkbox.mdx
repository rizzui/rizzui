...
<Paper>
  <div className="w-full max-w-md flex justify-around gap-4 flex-wrap">
    ...
    <Checkbox label="Flat" variant="flat" />
  </div>
</Paper>
...
<Paper>
  <div className="w-full max-w-xl flex justify-around gap-4 flex-wrap">
    <Checkbox label="Left Placement" labelPlacement="left" />
    <Checkbox label="Right Placement" labelPlacement="right" />
  </div>
</Paper>
...
|  iconClassName  |                `string`                |    Use iconClassName prop to apply some additional style for check mark icon    |    \_\_     |
