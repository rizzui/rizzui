...
Create a Select with custom filtering logic for complex data structures.
...
export default function CustomFilterSelect() {
  ...
  return (
    <Select
      ...
      displayValue={(selected) => {
        const product = products.find(p => p.id.toString() === selected);
...
|         onClear          |    [SelectOnClear](#select-onclear)     |                                                                                                          Callback function called when the clear button is clicked                                                                                                           |     \_\_      |
