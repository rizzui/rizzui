...
| :-------------------: | :-------------------------------------: | :----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------: | :-----------: |
|        options        | [`SelectOption[]`](#select-option-type) |                                                                                Add options data using this prop. **options** prop is requried.                                                                                 |     \_\_      |
|         value         |                   `T`                   |                                                                                        The selected value. **value** prop is requried.                                                                                         |     \_\_      |
|       onChange        |          `(value: T) => void`           |                                                                      The function to call when a new option is selected.. **onChange** prop is requried.                                                                       |     \_\_      |
