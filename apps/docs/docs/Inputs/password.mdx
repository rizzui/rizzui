...
## With External Visibility State Management

You can manage visibility state externally using **showPassword** and **setShowPassword** properties.
...
|          showPassword         |               `boolean`                |                            It is an external state using which we can handle the visibility externally props.                             |    \_\_     |
|        setShowPassword        |     `((visible: boolean) => void)`     |                               It is a setState function which is used to handle the visibility externally.                                |    \_\_     |
