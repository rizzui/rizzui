...
<Paper className="block text-gray-950">
  <PasswordClearable label="Password" />
</Paper>
...
|            onClear            |  [PasswordOnclear](#password-onclear)  |                                                                Callback function called when the clear button is clicked                                                                |    \_\_     |
...
|     visibilityToggleIcon      |  `((visible: boolean) => ReactNode)`   |                                                Custom password visibility toggle icon. Receives the current visibility state as a parameter.                                                 |    \_\_     |
