...
import MultiSelectBox, {
  ...
  MultiSelectWithSearchAble } from "@site/src/components/multi-select";
...
|      onSearchChange      |             `(value: string) => void`             |                                                                                        The function to call when typing in the options search panel.                                                                                        |     \_\_      |
|         onClear          |                   `() => void `                   |                                                                                                              Callback function called when the clear button is clicked                                                                                                              |     \_\_      |
...
|          prefix          |                    `ReactNode`                    |                                              The prefix is designed for adding any icon or text on the Select field's start (it's a left icon for the `ltr` and right icon for the `rtl`)                                               |     \_\_      |
|          suffix          |                    `ReactNode`                    |                                               The suffix is designed for adding any icon or text on the Select field's end (it's a right icon for the `ltr` and left icon for the `rtl`)                                                |     \_\_      |
...
|    getOptionValueKey     |                     `string`                      |                                                                            Can use any property as value inside your options object rather than **value**                                                                             |     \_\_      |
...
|       searchPrefix       |                    `ReactNode`                    |                                              The prefix is designed for adding any icon or text on the Search field's start (it's a left icon for the `ltr` and right icon for the `rtl`)                                               |     \_\_      |
|       searchSuffix       |                    `ReactNode`                    |                                               The suffix is designed for adding any icon or text on the Search field's end (it's a right icon for the `ltr` and left icon for the `rtl`)                                                |     \_\_      |
...
```ts
type MultiSelectSizes = "sm" | "md" | "lg";
```
