...
<Tabs groupId="package-manager">
  ...
  >
    <CodeBlock language="js">
      {`npm i rizzui @headlessui/react @floating-ui/react tailwind-variants`}
    </CodeBlock>
  </TabItem>
  <TabItem
    value="yarn"
  ...
  >
    <CodeBlock language="js">
      {`yarn add rizzui @headlessui/react @floating-ui/react tailwind-variants`}
    </CodeBlock>
  </TabItem>
  <TabItem
    value="pnpm"
  ...
  >
    <CodeBlock language="js">
      {`pnpm add rizzui @headlessui/react @floating-ui/react tailwind-variants`}
    </CodeBlock>
  </TabItem>
  <TabItem
    value="bun"
  ...
  >
    <CodeBlock language="js">
      {`bun add rizzui @headlessui/react @floating-ui/react tailwind-variants`}
    </CodeBlock>
  </TabItem>
</Tabs>
