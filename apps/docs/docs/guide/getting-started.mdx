...
- **Package Manager**: pnpm 9.0+ (recommended), npm, or yarn
...
<Tabs groupId="package-manager">
  ...
  >
    <CodeBlock language="js">
      {`npm i rizzui @headlessui/react @floating-ui/react @tailwindcss/postcss tailwind-variants`}
    </CodeBlock>
  </TabItem>
  <TabItem
    value="yarn"
...
<div className="!mt-6 !mb-8 p-4 bg-blue-50 dark:bg-blue-950/30 rounded-lg border border-blue-200 dark:border-blue-800">
  ...
  **`@tailwindcss/postcss`** - Tailwind CSS v4 PostCSS processing engine -
