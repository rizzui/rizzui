...
## Note: v0.8.5 ( latest )
  If you are using **RizzUI** version **0.8.5**, the minimum required dependencies are **@headlessui/react** version **2.0.3** and **@floating-ui/react** version **0.26.13**. The **RizzUI** version **0.8.5** is fully compatible with the latest versions of **@headlessui/react** and **@floating-ui/react**.
