...
If you don't plan to use dark mode in your application, the current configuration is good to go. However, if you wish to implement both light and dark modes, please refer to our [dark mode documentation.](/docs/guide/dark-mode)
...
module.exports = {
  ...
  theme: {
    extend: {
      colors: {
        /*
        * body background & ring-offset-color
        */
