...
[data-theme='dark'] {
  ...
  --muted: oklch(32.11% 0 0);
  --muted-foreground: oklch(51.03% 0 0);

  /* Border Tokens */
  --border-color: oklch(91.58% 0 0);

  /* Text Tokens */
  --text-primary: oklch(100% 0 0);
  --text-secondary: oklch(51.03% 0 0);

  /* Primary Brand Colors */
  --primary-lighter: oklch(25.2% 0 0);
  --primary: oklch(95.81% 0 0);
  --primary-dark: oklch(100% 0 0);
  --primary-foreground: oklch(0% 0 0);

  /* Secondary Colors */
  --secondary-lighter: oklch(26.35% 0.1154 280.96);
  --secondary-dark: oklch(85.2% 0.0733 276.238);

  /* Danger/Error Colors */
  --red-lighter: oklch(27.08% 0.1111 29.23);
  --red-dark: oklch(86.69% 0.0714 18.6304);

  /* Warning Colors */
  --orange-lighter: oklch(28.29% 0.0698 49.34);
  --orange-dark: oklch(93.15% 0.1175 98.83);

  /* Info Colors */
  --blue-lighter: oklch(32.05% 0.0873 254.4);
  --blue-dark: oklch(90.53% 0.0611 225.72);

  /* Success Colors */
  --green-lighter: oklch(27.23% 0.0672 152.71);
  --green-dark: oklch(92.79% 0.086 155.61);
}
