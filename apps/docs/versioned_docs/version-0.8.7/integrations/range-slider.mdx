...
2. Create a range component, **components/range-slider.tsx**
...
```jsx
import { RangeSlider } from "rizzui-v0";
...
|              size               |          [RangesliderSizes](#rangeslider-sizes)           | Sizes of the component are: |   `"md"`    |
|              color              |         [Rangeslidercolors](#rangeslider-colors)          |     Change slider color     | `"primary"` |
...
- **Note:** You can check [**rc-slider documentation**](https://slider-react-component.vercel.app/) for more details.
