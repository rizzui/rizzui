...
import { Dropdown, Button, Text, ActionIcon, Avatar, cn } from "rizzui-v0";
...
```tsx
import { Dropdown } from "rizzui-v0";
```
...
```tsx
import { Dropdown, Button } from "rizzui-v0";
...
```tsx
import { Dropdown, Button, cn, ActionIcon } from "rizzui-v0";
import {
  AdjustmentsHorizontalIcon,
  PencilIcon,
  DocumentDuplicateIcon,
...
```tsx
import { Dropdown, Text, Avatar } from "rizzui-v0";
