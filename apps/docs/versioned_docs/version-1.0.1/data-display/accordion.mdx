...
<Paper className="block">
  <div>
    {defaultCollapseData.map((item) => (
      <Accordion
        key={item.title}
        className="mx-8 border-b border-gray-200 last-of-type:border-b-0"
      >
        <Accordion.Header>
          {({ open }) => (
        ...
        <Accordion.Body className="mb-7 text-[15px]">
          {item.content}
        </Accordion.Body>
      </Accordion>
    ))}
...
import { Accordion } from "rizzui-v1";
import { ChevronDownIcon } from "@heroicons/react/24/solid";
  ...
  <div className="rounded-3xl border border-gray-200">
    {customStyleCollapseData.map((item) => (
      <Accordion
        ...
        className="mx-8 my-2 border-b border-gray-200 last-of-type:border-b-0"
      >
        <Accordion.Header>
          {({ open }) => (
        ...
        <Accordion.Body className="mb-7 text-[15px]">{item.content}</Accordion.Body>
      </Accordion>
    ))}
  </div>
</Paper>
...
import { Accordion, Avatar } from "rizzui-v1";
