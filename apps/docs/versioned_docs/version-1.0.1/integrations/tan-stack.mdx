...
```ts
import { type Person } from "./data";
import { ActionIcon, Badge, Button, Checkbox, Popover, Text } from "rizzui-v1";
...
```ts
import { ActionIcon, Select, SelectOption, Text } from "rizzui-v1";
...
```ts
import { ActionIcon, Badge, Button, Checkbox, Input, Popover, Select, Text, Title } from "rizzui-v1";
import { type Table as ReactTableType } from "@tanstack/react-table";
import {
...
import { Avatar, AvatarProps, Badge, cn, Text } from "rizzui-v1";
