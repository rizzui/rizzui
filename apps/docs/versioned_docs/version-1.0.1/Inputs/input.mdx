...
<Paper className="gap-4 justify-start items-start text-gray-950">
  <Input type="email" size="sm" label="Small" placeholder="Enter your email" />
  <Input type="email" label="Default" placeholder="Enter your email" />
  <Input type="email" size="lg" label="Large" placeholder="Enter your email" />
  <Input
    type="email"
    size="xl"
    label="Extra Large"
...
<Paper className="block text-gray-950">
  <Input label="Name" placeholder="Your Name" error="This field is required" />
</Paper>
...
|     rounded     |  [InputRounded](#input-rounded)  |                                                         The rounded variants are:                                                         |   `"md"`    |
