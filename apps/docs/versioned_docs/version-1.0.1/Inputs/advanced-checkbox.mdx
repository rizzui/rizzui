...
import { AdvancedCheckbox, Text } from "rizzui-v1";
import {
...
```jsx
import { AdvancedCheckbox } from "rizzui-v1";
```
...
```jsx
import { AdvancedCheckbox, CheckboxGroup, Text } from "rizzui-v1";
...
|     rounded      | [CheckboxRounded](#advanced-checkbox-rounded) |                            The rounded variants are:                            | `"md"`  |
