...
import { InstallationCommand, PostInstallationCommand} from '@site/src/components/code-editors/api-sdk';
...
<div className="mt-4 mb-8 ">
  **Note:** **RizzUI** is now support **React19**. Please don't forget to use **@headlessui/react@2.0.3** and
  **@floating-ui/react@0.26.13** for the latest **rizzui**.
</div>

Now Install and configure TailwindCSS to have the style.

<PostInstallationCommand />
