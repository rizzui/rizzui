    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800 p-8">
      <div className="max-w-7xl mx-auto space-y-12">
        ...
        <div className="text-center space-y-4">
          <h1 className="text-5xl font-bold text-gray-900 dark:text-white">Tooltip Component</h1>
          <p className="text-lg text-gray-600 dark:text-gray-300">Hover tooltip for additional information</p>
        ...
        <section className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-8">
          ...
          <div className="flex flex-wrap gap-4">
            ...
            <Tooltip content="Primary info" color="primary">
              <Button variant="solid">Primary</Button>
            </Tooltip>
            <Tooltip content="This is important!" color="danger">
