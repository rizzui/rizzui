...
export default defineConfig({
  entry: {
    ...
    code: 'src/components/typography/code/index.ts',
    blockquote: 'src/components/typography/blockquote/index.ts',
    upload: 'src/components/upload/index.ts',
    'file-input': 'src/components/upload/file-input.tsx',
    'upload-zone': 'src/components/upload/upload-zone.tsx',
    ...
    highlight: 'src/components/highlight/index.ts',
    cn: 'src/lib/cn.ts',
    variants: 'src/lib/variants/index.ts',
    useCollapse: 'src/components/collapse/use-collapse.ts',
  },
  format: ['esm', 'cjs'],
  dts: true,
  clean: true,
